...
#+description: Uno tiene la costumbre, y el entrenamiento, de intentar perderse los menos detalles posibles. El emblema que preside esta página: hermann-uwe , la cual visito desde hace mucho tiempo, me intrigaba. Cuanto más tiempo transcurría sin saber su verdadero significado mayor era la intriga. Hoy he podido leer a placer...
#+filetags: GNU/Linux Pensamiento Programación Seguridad
#+options: _:nil
#+nid: 90

#+begin_export html
<a href="/node/88" target="_self"><img width="55" height="55" border="0" align="right" hspace="10" vspace="10" src="/static/img/glider.png"></a>
#+end_export
Uno tiene la costumbre, y el entrenamiento, de intentar perderse los menos detalles posibles. *El emblema* que preside esta página: [[http://www.hermann-uwe.de/][hermann-uwe]], la cual visito desde hace mucho tiempo, me intrigaba. Cuanto más tiempo transcurría sin saber su verdadero significado mayor era la intriga. Hoy he podido leer a placer...

Este emblema es el elegido por la comunidad [[http://es.wikipedia.org/wiki/Hacker][hacker]] para, entre otras cosas, fortalecer las señas de identidad de la misma. Es curioso el uso, y la [[http://www.catb.org/hacker-emblem/faqs.html][justificación de éste]], propuesto por su creador, [[http://www.catb.org/~esr/][Eric Steven Raymond]].
...
¿Y cuál es la cultura hacker? Para responder a esta pregunta tenía que leerme el pequeño documento en el que este mismo autor intenta explicar: [[http://www.catb.org/~esr/faqs/hacker-howto.html]["Como llegar a ser un hacker"]].
...
¿En qué consiste el desarrollo de la "actitud vital"? 1.- *Los hackers creen en la libertad y en la ayuda mutua*. Los hacker resuelven problemas y crean soluciones útiles para la humanidad (entre ellas lo que hoy todo el mundo conoce como Internet).
...
¿Cuáles son las habilidades a desarrollar? 1.- Aprender a programar *en varios lenguajes* ("It's best, actually, to learn all five of Python, C/C++, Java, Perl, and LISP").
...
[[https://docs.google.com/forms/d/e/1FAIpQLSeGnXB3zyaNVYcb_2EoO8C5HRc6Emx-2rv2QS6OWNFz1yYSBQ/viewform?usp=pp_url&entry.55081144=%C2%BFSoy%20un%20hacker%3F][Dejar comentario]].
